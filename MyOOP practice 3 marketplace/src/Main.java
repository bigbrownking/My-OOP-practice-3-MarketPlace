            ...
            switch (selection) {
                ...
                case 2:
                    try (Connection conn = DriverManager.getConnection(DBEngine.url, DBEngine.user, DBEngine.password)) {
                        ...
                        switch (select) {
                            case 1:
                                System.out.println("Choose the brand: (Sanc, 2E, Acer, Asus, LG, Xiaomi, Neo,Kordis, HP, VEGA, AOC, Samsung)\n"+
                                        "0. Exit\n");
                                sc.nextLine();
                                String inputBrand = sc.nextLine();
                                if (inputBrand.equals("0")){
                                    repeat();
                                }
                                resultSet1 = statement.executeQuery("SELECT * FROM screen WHERE brend LIKE " + "'" + inputBrand + "'");
                                ...
                                System.out.println("Which type of matrix?(VA, IPS, TN, TFT*VA)\n"+
                                        "0. Exit");
                                String inputMatrix = sc.nextLine();
                                if(inputMatrix.equals("0")){
                                    repeat();
                                }
                                resultSet1 = statement.executeQuery("SELECT * FROM screen WHERE brend LIKE " + "'" + inputBrand + "' AND matrix LIKE " + "'" + inputMatrix + "'");
                                while (resultSet1.next()) {
                                    int id = resultSet1.getInt(1);
                                    String model = resultSet1.getString(8);
                                    String brand = resultSet1.getString(7);
                                ...
                                statement1.executeUpdate("DELETE FROM screen WHERE amount <=0");
                                System.out.println("Added");
                                break;
                            case 2:
                                System.out.println("Choose the brand: (ASUS, Trust, Lenovo,Razer,Logitech,Defender,Xiaomi,Apple,HyperX,X-Game)\n"+
                                        "0. Exit");
                                sc.nextLine();
                                inputBrand = sc.nextLine();
                                if (inputBrand.equals("0")){repeat();}
                                resultSet1 = statement.executeQuery("SELECT * FROM mouse WHERE brend LIKE " + "'" + inputBrand + "'");
                                while (resultSet1.next()) {
                                    int id = resultSet1.getInt(1);
                                    ...
                                    int price = resultSet1.getInt(7);
                                    System.out.printf("%d. Model: %s; Brand: %s; Connection type: %s; Buttons count: %d; Weight: %f; Sensitivity: %s; Price: %d tenge; Count: %d\n", id, model, brand, connection_type, buttons, weight, Sensitivity, count, price);
                                }
                                System.out.println("Which type of connection?(Wired, Wireless)\n"+
                                        "0. Exit");
                                String inputCon = sc.next();
                                resultSet1 = statement.executeQuery("SELECT * FROM mouse WHERE brend LIKE " + "'" + inputBrand + "' AND Con LIKE " + "'" + inputCon + "'");
                                while (resultSet1.next()) {
                                    int id = resultSet1.getInt(1);
                                    String model = resultSet1.getString(3);
                                    String brand = resultSet1.getString(6);
                                ...
                                if (product_id2 == 0)repeat();
                                resultSet1 = statement.executeQuery("SELECT * FROM mouse WHERE brend LIKE " + "'" + inputBrand + "' AND Con LIKE " + "'" + inputCon + "'");
                                while (resultSet1.next()) {
                                    if (resultSet1.getInt(1) == product_id2) {
                                        Statement statement2 = conn.createStatement();
                                        statement2.executeUpdate("UPDATE mouse SET amount = amount - 1");
                                        int id = resultSet1.getInt(1);
                                        String model = resultSet1.getString(3);
                                        String brand = resultSet1.getString(6);
                                        String connection_type = resultSet1.getString(9);
                                ...
                                break;
                            case 3:
                                System.out.println("Choose the brand: (Defender, HyperX, Logitech, Apple, Dell, Acer, X-Game, Fstyler,Razer,Ajax, Milesight)\n"+
                                        "0. Exit");
                                sc.nextLine();
                                String inputBrand3 = sc.next();
                                if(inputBrand3.equals("0"))repeat();
                                resultSet1 = statement.executeQuery("SELECT * FROM keyboard WHERE brend LIKE " + "'" + inputBrand3 + "'");
                                while (resultSet1.next()) {
                                    int id = resultSet1.getInt(1);
                                    String model = resultSet1.getString(3);
                                ...
                                System.out.println("Which type of buttons? (Membrane, Mechanical)\n"+
                                        "0. Exit");
                                sc.nextLine();
                                String inputBut = sc.next();
                                if(inputBut.equals("0"))repeat();
                                resultSet1 = statement.executeQuery("SELECT * FROM keyboard WHERE brend LIKE " + "'" + inputBrand3 + "' AND type_of_buttons LIKE " + "'" + inputBut + "'");
                                while (resultSet1.next()) {
                                    int id = resultSet1.getInt(1);
                                    String model = resultSet1.getString(3);
                                    String brand = resultSet1.getString(4);
                                ...
                                break;
                            case 4:
                                System.out.println("Choose brand: (Intel, AMD)\n"+
                                        "0. Exit");
                                sc.nextLine();
                                String inputBrand2 = sc.next();
                                if(inputBrand2.equals("0"))repeat();
                                resultSet1= statement.executeQuery("SELECT * FROM processor WHERE brend LIKE " + "'" + inputBrand2+"'");
                                while (resultSet1.next()) {
                                    int id = resultSet1.getInt(1);
                                    String model = resultSet1.getString(3);
                                    String brand = resultSet1.getString(7);
                                ...
                                if(inputBrand2.equals("Intel")) {
                                    System.out.println("What type? (Core i3,i5, i7, i9, Xeon Gold, Xeon Silver, Intel Celeron, Xeon\n"+
                                            "0. Exit");
                                    sc.nextLine();
                                    String inputType = sc.nextLine();
                                    if(inputType.equals("0"))repeat();
                                    String sql = "SELECT * FROM processor WHERE brend LIKE " + "'" + inputBrand2 + "' AND kind LIKE " + "'" + inputType + "'";
                                    ...
                                    System.out.println("What type? (Ryzen 5, Ryzen 9)\n"+
                                            "0. Exit");
                                    sc.nextLine();
                                    String inputType = sc.nextLine();
                                    if(inputType.equals("0"))repeat();
                                ...
                                break;
                            case 5:
                                System.out.println("Choose type of laptop: (Gaming, Air, Pro, Office)\n"+
                                        "0. Exit");
                                sc.nextLine();
                                String inputBrand5 = sc.next();
                                if(inputBrand5.equals("0"))repeat();
                                resultSet1= statement.executeQuery("SELECT * FROM laptop WHERE kind LIKE " + "'" + inputBrand5+"'");
                                while (resultSet1.next()) {
                                    int id = resultSet1.getInt(1);
                                ...
                                System.out.println("Which OS? (Windows, Mac, Linux)\n"+
                                        "0. Exit");
                                sc.nextLine();
                                String inputOS = sc.nextLine();
                                if(inputOS.equals("0"))repeat();
                                resultSet1 = statement.executeQuery("SELECT * FROM laptop WHERE kind LIKE " + "'" + inputBrand5 + "' AND OS LIKE " + "'" + inputOS + "'");
                                while (resultSet1.next()) {
                                    int id = resultSet1.getInt(1);
                                    String os = resultSet1.getString(2);
                                    String type = resultSet1.getString(3);
                                    ...
                                    try (Connection conn = DriverManager.getConnection(DBEngine.url, DBEngine.user, DBEngine.password)) {
                                        ...
                                        switch (admin_sel) {
                                            ...
                                            case 2:
                                                ...
                                                while (resultSet2.next()) {
                                                    if (resultSet2.getInt(1) == mouse_id) {
                                                        String sql = "DELETE FROM mouse WHERE id = " + mouse_id;
                                                        statement.executeUpdate(sql);
                                                        System.out.print("ID: ");
                                                        int id = sc.nextInt();
                                                        sc.nextLine();
                                            ...
                                            case 3:
                                                ...
                                                while (resultSet2.next()) {
                                                    if (resultSet2.getInt(1) == keyboard_id) {
                                                        String sql = "DELETE FROM keyboard WHERE id = " + keyboard_id;
                                                        statement.executeUpdate(sql);
                                                        System.out.print("ID: ");
                                                        int id = sc.nextInt();
                                                        sc.nextLine();
                                            ...
                                            case 4:
                                                ...
                                                resultSet2 = statement.executeQuery("SELECT * FROM processor");
                                                while (resultSet2.next()) {
                                                    if (resultSet2.getInt(1) == processor_id) {
                                                        String sql = "DELETE FROM processor WHERE id = " + processor_id;
                                                        statement.executeUpdate(sql);
                                                        System.out.print("ID: ");
                                                        int id = sc.nextInt();
                                                        sc.nextLine();
                                            ...
                                            case 5:
                                                ...
                                                resultSet2 = statement.executeQuery("SELECT* FROM laptop");
                                                while (resultSet2.next()) {
                                                    if (resultSet2.getInt(1) == laptop_id) {
                                                        String sql = "DELETE FROM laptop WHERE id = " + laptop_id;
                                                        statement.executeUpdate(sql);
                                                        System.out.print("Id: ");
                                                        int id = sc.nextInt();
                                                        System.out.print("OS: ");
                                    ...
                                    try (Connection conn = DriverManager.getConnection(DBEngine.url, DBEngine.user, DBEngine.password)) {
                                        ...
                                        switch (admin_sel) {
                                            case 1:
                                                ...
                                                break;
                                            case 2:
                                                resultSet3 = statement.executeQuery("SELECT * FROM mouse");
                                                while (resultSet3.next()) {
                                                ...
                                                break;
                                            case 3:
                                                resultSet3 = statement.executeQuery("Select * FROM keyboard");
                                                while (resultSet3.next()) {
                                                    id = resultSet3.getInt(1);
                                                    model = resultSet3.getString(3);
                                                    brand = resultSet3.getString(4);
                                                    String Interface = resultSet3.getString(6);
                                                    String type_of_buttons = resultSet3.getString(5);
                                                    weight = resultSet3.getDouble(8);
                                                    price = resultSet3.getInt(2);
                                                    count = resultSet3.getInt(7);
                                                    System.out.printf("%d. Model: %s; Brand: %s; Interface: %s; Type of buttons: %s; Weight: %f grams; Price: %d tenge; Count: %d\n", id, model, brand, Interface, type_of_buttons, weight, price, count);
                                                }
                                                System.out.print("ID: ");
                                                id = sc.nextInt();
                                                ...
                                                break;
                                            case 4:
                                                resultSet3 = statement.executeQuery("SELECT * FROM processor");
                                                while (resultSet3.next()) {
                                                    id = resultSet3.getInt(1);
                                                    model = resultSet3.getString(3);
                                                    brand = resultSet3.getString(7);
                                                    String type = resultSet3.getString(9);
                                                    int countNucleus = resultSet3.getInt(5);
                                                    double Ghz = resultSet3.getDouble(4);
                                                    int storage = resultSet3.getInt(8);
                                                    price = resultSet3.getInt(2);
                                                    count = resultSet3.getInt(6);
                                                ...
                                                break;
                                            case 5:
                                                resultSet3 = statement.executeQuery("SELECT* FROM laptop");
                                                System.out.println("All available laptops: ");
                                                while (resultSet3.next()) {
                                                    id = resultSet3.getInt(1);
                                                    String os = resultSet3.getString(2);
                                                    type = resultSet3.getString(3);
                                                    String characteristic = resultSet3.getString(4);
                                                    int number = resultSet3.getInt(5);
                                                    price = resultSet3.getInt(6);
                                                    brand = resultSet3.getString(7);
                                                    System.out.printf("%d. Os: %s; Type: %s; Brand: %s; Characteristic: %s; Price: %d tenge; Count: %s; \n", id, os, type, brand, characteristic, price, number);
                                                }
                                                System.out.print("Id: ");
